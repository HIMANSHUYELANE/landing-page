const Home = () => {
  return (
    <>
      <main className="py-5">
        <section className=" my-5 flex justify-evenly text-white">
          <div className="w-[40%] self self-center">
            <div className="text-wrap space-y-2">
              ...
              <h1 className="text-4xl text-sky-400 font-bold italic py-2">
            ...
            <div className="mt-7 flex gap-5">
              <button className="bg-sky-600 font-medium border-2 border-sky-500 rounded-md px-3">
                Login
              </button>
          ...
          <div>
            <img className="h-[500px]" src="./images/home.jpg" alt="" />
          </div>
        </section>
        ...
        <section className="flex text-white my-14 w-[90%] mx-auto">
            ...
            <div className="">
              ...
              <div className="font-light text-sm space-y-2">
                <p>
                  ...
                  necessitatibus inventore omnis iste exercitationem ut rem!
                  Tempora iste dicta asperiores?
                </p>
                <p>
                  pragram2 Lorem ipsum dolor, sit amet consectetur adipisicing
                  elit. Delectus, quis autem perspiciatis culpa mollitia
                  doloribus magnam ab.
                </p>
                <p>
                ...
                <p>
                  partagraph4 Lorem, ipsum dolor sit amet consectetur
                  adipisicing elit. Ipsam suscipit repellat officiis veritatis.
                  Obcaecati quis at sit autem beatae
                </p>
              </div>
            </div>
          <div>
          ...
          <div className="self-center">
            <img className="h-96" src="./images/about.png" alt="" />
          </div>
        </section>

        <section className="py-10 bg-slate-600 w-[90%] mx-auto flex text-center justify-evenly  text-white ">
